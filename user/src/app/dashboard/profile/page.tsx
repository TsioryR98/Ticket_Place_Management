    ...
    return (
        <div className="flex flex-row items-center gap-x-10 justify-center mt-8">
            <div className="flex flex-col gap-y-8">
                <div
                    className="p-5 shadow-md flex items-center flex-col cursor-pointer hover:shadow-xl transition-all duration-300">
                    <h1 className="font-semibold text-lg flex items-center">Account Settings <CiSettings
                        className="ms-4 text-2xl"/></h1>
                    <p className="text-sm">Details about your information</p>
                </div>
                <Link href={`/dashboard/reservations`}>
                    <div
                        className="p-5 shadow-md flex items-center flex-col cursor-pointer hover:shadow-xl transition-all duration-300">
                        <h1 className="font-semibold text-lg flex items-center">My reservations <CiBookmark
                            className="ms-4 text-2xl"/></h1>
            ...
            <div className="flex flex-col gap-y-8">
                <div
                    className="flex items-center  p-8 shadow-md hover:shadow-xl transition-all duration-300 justify-between">
                    <div className="flex items-center gap-x-8">
                        <div
                            className="w-20 h-20 flex items-center justify-center rounded-full bg-gray-500 text-white text-2xl  font-semibold text-center">
