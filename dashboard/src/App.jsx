...
import { EventCreate, EventEdit, EventList, EventShow } from './resource/EventResource';
...
export const App = () => (
  <Admin loginPage={SignIn} dataProvider={dataProvider} authProvider={authProvider}>
    ...
    <CustomRoutes>
      <Route path="/events/:id/show-with-orders" element={<EventShowWithOrders />} />
    </CustomRoutes>
  </Admin>
);
