...
INSERT INTO events (title, descriptions, event_datetime, locations, organizer, category, imagepath) VALUES (
...
-- The Cinelli Brothers @ Le Blues Autour du Zinc
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'The Cinelli Brothers live @ Le Blues Autour du Zinc'),
    'Standard',
    25.00,
    100,
    4,
...
-- Bernard (FR) @ Pub Montmartre
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Bernard (FR) en concert'),
    'Standard',
    15.00,
    80,
    4,
...
-- Rosa Bursztein @ THEATRE DE L'OEUVRE
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Rosa Bursztein : Dédoublée'),
    'Standard',
    30.00,
    150,
    6,
...
-- Bermud @ SUPERSONIC
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Bermud en concert'),
    'Standard',
    20.00,
    120,
    4,
...
-- FENCES + THE INTERSPHERE @ La Boule Noire
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'FENCES + THE INTERSPHERE'),
    'Standard',
    25.00,
    200,
    4,
...
-- The Intersphere @ La Boule Noire
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'The Intersphere en concert'),
    'Standard',
    22.00,
    180,
    4,
...
-- Biga*Ranx @ LA CIGALE
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Biga*Ranx à La Cigale'),
    'Standard',
    35.00,
    300,
    4,
...
-- Droges @ FGO-Barbara
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Droges en concert'),
    'Standard',
    18.00,
    90,
    4,
...
-- Gaffa Tape Sandy @ Le Klub
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Gaffa Tape Sandy'),
    'Standard',
    15.00,
    70,
    4,
...
-- Gavin James @ LE TRABENDO
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Gavin James en concert'),
    'Standard',
    28.00,
    250,
    4,
...
-- Gad Elmaleh @ Elispace
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Gad Elmaleh : Lui-même'),
    'Standard',
    50.00,
    500,
    6,
...
-- OMED @ Bonnie Club
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'OMED au Bonnie Club'),
    'Standard',
    20.00,
    200,
    4,
...
-- Stax @ Les Apaches
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Anniversaire DJ Aleathory aux Apaches'),
    'Standard',
    15.00,
    150,
    4,
...
-- Mae Andrazz @ Protestant Evangelical Church
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Mae Andrazz : Ombre et Lumière'),
    'Standard',
    12.00,
    80,
    4,
...
-- Meskerem Mees @ MC93
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Meskerem Mees: Rosas - Exit Above'),
    'Standard',
    25.00,
    120,
    4,
...
-- Locomuerte @ L''Empreinte
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Locomuerte - Warm-Up Plane''r Fest'),
    'Standard',
    18.00,
    200,
    4,
...
-- Simon McBride @ Backstage By The Mill
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Simon McBride en concert'),
    'Standard',
    30.00,
    150,
    4,
...
-- A2H @ MJC de la Vallée
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'A2H en concert'),
    'Standard',
    10.00,
    100,
    4,
...
-- Nadim @ Le Métropole
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Nadim en concert'),
    'Standard',
    22.00,
    120,
    4,
...
-- Ben l''Oncle Soul @ Espace Lumière
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Ben l''Oncle Soul en concert'),
    'Standard',
    35.00,
    300,
    4,
...
-- Ensemble Musicâme France @ Église de Saint Germain des Prés
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Rêverie parisienne : Debussy, Ravel, Bizet, Rameau, Fauré, Chaminade'),
    'Standard',
    28.00,
    150,
    4,
...
-- The Buttshakers @ salle des fêtes de Néron
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'The Buttshakers - Jazz de Mars'),
    'Standard',
    15.00,
    100,
    4,
...
-- Ÿuma @ Be Jazzy
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Ÿuma en concert'),
    'Standard',
    20.00,
    80,
    4,
...
-- The Cinelli Brothers @ Festival Jazz à toute Heure
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'The Cinelli Brothers live @ Festival Jazz à toute Heure'),
    'Standard',
    30.00,
    200,
    4,
...
-- Photøgraph @ Studios 240
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Photøgraph en concert'),
    'Standard',
    15.00,
    70,
    4,
...
-- Red Beans and Pepper Sauce @ Espace Florence Leblond
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Red Beans and Pepper Sauce'),
    'Standard',
    12.00,
    90,
    4,
...
-- Didier Gustin @ Saint Exupéry Space
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Didier Gustin : Johnny libre dans ma tête'),
    'Standard',
    35.00,
    250,
    4,
...
-- DJ Mad Dog @ Le Nexus
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'DJ Mad Dog au Nexus'),
    'Standard',
    20.00,
    300,
    4,
...
-- HanniBaSs @ DISSIDANCE
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Dissidance présente HanniBaSs'),
    'Standard',
    25.00,
    200,
    4,
...
-- Jolly @ La Gare / Le Gore
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Jolly à La Gare / Le Gore'),
    'Standard',
    15.00,
    150,
    4,
...
-- Pop Fiction @ Apollo Théâtre
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Pop Fiction - Film improvisé'),
    'Standard',
    18.00,
    120,
    4,
...
-- REAVEN @ Les Agla''scènes
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'REAVEN aux Agla''scènes'),
    'Standard',
    15.00,
    100,
    4,
...
-- Eli Waltz @ El Zókalo
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Eli Waltz : Fairytales & Ghosts Tour'),
    'Standard',
    20.00,
    60,
    4,
...
-- Emajeur @ Conservatory De Vanves
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Emajeur - Tremplin SO JAM Demi-Finale'),
    'Standard',
    10.00,
    150,
    4,
...
-- Kazam @ Grand Marché Stalingrad
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Kazam à Solarium'),
    'Standard',
    25.00,
    300,
    4,
...
-- DJ Suspect @ Sacré
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'DJ Suspect au Sacré'),
    'Standard',
    20.00,
    200,
    4,
...
-- Tatie Dee @ Badaboum
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Tatie Dee au Badaboum'),
    'Standard',
    15.00,
    150,
    4,
...
-- Thomas Naïm Solo @ Auditorium Rostropovitch
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Thomas Naïm Solo - Festival Blues Autour du Zinc'),
    'Standard',
    25.00,
    120,
    4,
...
-- Nirvana UK @ Zenith Paris
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Nirvana UK - Hommage à Nirvana'),
    'Standard',
    40.00,
    500,
    4,
...
-- Durand Jones & The Indications @ Théâtre Equestre Zingaro
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Durand Jones & The Indications'),
    'Standard',
    35.00,
    300,
    4,
...
-- Monsieur Lune @ Festival À Tout Bout de Chant
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Monsieur Lune - L''Ascenseur Cosmique'),
    'Child',
    8.00,
    100,
    4,
...
-- Matthieu Souchet @ Bar Gallia
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Matthieu Souchet - Maître Mim''s'),
    'Standard',
    15.00,
    50,
    4,
...
-- Grissini Project @ Salle Cortot
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'Grissini Project : Les Plus Belles Musiques des Films de Miyazaki'),
    'Standard',
    30.00,
    150,
    4,
...
-- Maximum Tour Music @ L''Empreinte
INSERT INTO tickets (event_id, types, price, available, limit_per_person, created_at) VALUES (
    (SELECT event_id FROM events WHERE title = 'LOCOMUERTE - SAVIGNY-LE-TEMPLE (77) - L''Empreinte'),
    'Standard',
    20.00,
    200,
    4,
